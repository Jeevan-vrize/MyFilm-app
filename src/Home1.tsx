...
import './App.css';
import { FaPlus, FaHeart, FaMoon, FaSun } from 'react-icons/fa';
            ...
            visibleFavorites.map((movie) => (
              <div className="watchlist-card" key={movie.id}>
                ...
                <div className="watchlist-details">
                  ...
                  <p>{movie.release_date}</p>
                  <p>IMDb {movie.vote_average} ⭐</p>
                  <button className="remove-btn" onClick={() => handleRemoveFromFavorites(movie.id)}>
                    Remove
                  </button>
                </div>
              </div>
            ...
            visibleWatchlists.map((movie) => (
              <div className="watchlist-card" key={movie.id}>
                ...
                <div className="watchlist-details">
                  ...
                  <p>{movie.release_date}</p>
                  <p>IMDb {movie.vote_average} ⭐</p>
                  <button className="remove-btn" onClick={() => handleRemoveFromWatchlist(movie.id)}>
                    Delete
                  </button>
                </div>
              </div>
